...
func init() {
	runtime.RegisterNSLoader("gist/core", LoadNS)
}
...
// LoadNS initializes the namespace "gist.core"
func LoadNS() {
	...
	sym_GIST_API_TOKEN := lang.NewSymbol("GIST_API_TOKEN")
	sym_GIST_API_TOKEN_FILE := lang.NewSymbol("GIST_API_TOKEN_FILE")
	sym_HOME := lang.NewSymbol("HOME")
	...
	sym_api_DASH_token := lang.NewSymbol("api-token")
	sym_api_DASH_url := lang.NewSymbol("api-url")
	...
	sym_files := lang.NewSymbol("files")
	...
	sym_gist_DOT_core := lang.NewSymbol("gist.core")
	...
	sym_html_url := lang.NewSymbol("html_url")
	...
	sym_re_DASH_stdin := lang.NewSymbol("re-stdin")
	...
	kw_Authorization := lang.NewKeyword("Authorization")
	...
	// var gist.core/ARGS
	var_gist_DOT_core_ARGS := lang.InternVarName(sym_gist_DOT_core, sym_ARGS)
	// var gist.core/ARGV
	var_gist_DOT_core_ARGV := lang.InternVarName(sym_gist_DOT_core, sym_ARGV)
	// var gist.core/CWD
	var_gist_DOT_core_CWD := lang.InternVarName(sym_gist_DOT_core, sym_CWD)
	// var gist.core/DIR
	var_gist_DOT_core_DIR := lang.InternVarName(sym_gist_DOT_core, sym_DIR)
	// var gist.core/ENV
	var_gist_DOT_core_ENV := lang.InternVarName(sym_gist_DOT_core, sym_ENV)
	// var gist.core/FILE
	var_gist_DOT_core_FILE := lang.InternVarName(sym_gist_DOT_core, sym_FILE)
	// var gist.core/NS
	var_gist_DOT_core_NS := lang.InternVarName(sym_gist_DOT_core, sym_NS)
	// var gist.core/RUN
	var_gist_DOT_core_RUN := lang.InternVarName(sym_gist_DOT_core, sym_RUN)
	// var gist.core/VERSION
	var_gist_DOT_core_VERSION := lang.InternVarName(sym_gist_DOT_core, sym_VERSION)
	// var gist.core/-main
	var_gist_DOT_core__DASH_main := lang.InternVarName(sym_gist_DOT_core, sym__DASH_main)
	// var gist.core/api-token
	var_gist_DOT_core_api_DASH_token := lang.InternVarName(sym_gist_DOT_core, sym_api_DASH_token)
	// var gist.core/api-url
	var_gist_DOT_core_api_DASH_url := lang.InternVarName(sym_gist_DOT_core, sym_api_DASH_url)
	// var gist.core/main
	var_gist_DOT_core_main := lang.InternVarName(sym_gist_DOT_core, sym_main)
	// var gist.core/re-stdin
	var_gist_DOT_core_re_DASH_stdin := lang.InternVarName(sym_gist_DOT_core, sym_re_DASH_stdin)
	// var ys.http/post
	...
	_ = reflect.TypeOf
	ns := lang.FindOrCreateNamespace(sym_gist_DOT_core)
	_ = ns
	...
	// ARGS
	{
		...
		var_gist_DOT_core_ARGS.SetDynamic()
	}
	// ARGV
	{
		...
		var_gist_DOT_core_ARGV.SetDynamic()
	}
	// CWD
	{
		...
		var_gist_DOT_core_CWD.SetDynamic()
	}
	// DIR
	{
		...
		var_gist_DOT_core_DIR.SetDynamic()
	}
	// ENV
	{
		...
		var_gist_DOT_core_ENV.SetDynamic()
	}
	// FILE
	{
		...
		var_gist_DOT_core_FILE.SetDynamic()
	}
	// NS
	{
		...
		var_gist_DOT_core_NS.SetDynamic()
	}
	// RUN
	{
		...
		var_gist_DOT_core_RUN.SetDynamic()
	}
	// VERSION
	{
		...
		var_gist_DOT_core_VERSION = ns.InternWithValue(tmp0, "0.1.1", true)
		if tmp0.Meta() != nil {
	...
	// -main
	{
		...
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			...
			default:
				...
				{ // let
					...
					tmp8 := lang.InternVarName(sym_gist_DOT_core, sym_ARGV)
					...
					tmp13 := lang.InternVarName(sym_gist_DOT_core, sym_ARGS)
					...
					tmp18 := checkDerefVar(var_gist_DOT_core_main)
		...
		var_gist_DOT_core__DASH_main = ns.InternWithValue(tmp0, tmp1, true)
		if tmp0.Meta() != nil {
			var_gist_DOT_core__DASH_main.SetMeta(tmp0.Meta().(lang.IPersistentMap))
		}
	}
	// api-token
	{
		...
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			...
			var tmp2 any
			{ // let
				// let binding "api-token-file"
				var tmp3 any
				{ // let
					// let binding "or__0__auto__"
					tmp4 := checkDerefVar(var_ys_DOT_std_truey_QMARK_)
					tmp5 := checkDerefVar(var_ys_DOT_std_get_PLUS_)
					tmp6 := checkDerefVar(var_gist_DOT_core_ENV)
					tmp7 := lang.Apply(tmp5, []any{tmp6, sym_GIST_API_TOKEN_FILE})
					...
					if lang.IsTruthy(v9) {
						...
						tmp11 := checkDerefVar(var_ys_DOT_std_truey_QMARK_)
						tmp12 := checkDerefVar(var_clojure_DOT_core_str)
						tmp13 := checkDerefVar(var_ys_DOT_std_get_PLUS_)
						tmp14 := checkDerefVar(var_gist_DOT_core_ENV)
						tmp15 := lang.Apply(tmp13, []any{tmp14, sym_HOME})
						tmp16 := lang.Apply(tmp12, []any{tmp15, "/.gist-api-token"})
				...
				var v4 any = tmp3
				_ = v4
				tmp5 := checkDerefVar(var_ys_DOT_std_chomp)
				var tmp6 any
				tmp7 := checkDerefVar(var_ys_DOT_std_fs_DASH_f)
				tmp8 := lang.Apply(tmp7, []any{v4})
				if lang.IsTruthy(tmp8) {
					tmp9 := checkDerefVar(var_ys_DOT_std_read)
					tmp10 := lang.Apply(tmp9, []any{v4})
					tmp6 = tmp10
				} else {
					var tmp11 any
					tmp12 := checkDerefVar(var_ys_DOT_std_get_PLUS_)
					tmp13 := checkDerefVar(var_gist_DOT_core_ENV)
					tmp14 := lang.Apply(tmp12, []any{tmp13, sym_GIST_API_TOKEN})
					if lang.IsTruthy(tmp14) {
						tmp15 := checkDerefVar(var_ys_DOT_std_get_PLUS_)
						tmp16 := checkDerefVar(var_gist_DOT_core_ENV)
						tmp17 := lang.Apply(tmp15, []any{tmp16, sym_GIST_API_TOKEN})
						tmp11 = tmp17
					} else {
						var tmp18 any
						if lang.IsTruthy(kw_else) {
							...
							{ // let
								// let binding "resp"
								tmp20 := checkDerefVar(var_ys_DOT_std_sh)
								tmp21 := lang.Apply(tmp20, []any{"bash -c '\n  echo -n \"Enter your GitHub API Token: \" >/dev/tty\n  read -r -s token </dev/tty\n  echo $token\n'\n"})
								var v22 any = tmp21
								_ = v22
								tmp23 := checkDerefVar(var_ys_DOT_std_say)
								tmp24 := lang.Apply(tmp23, []any{""})
								_ = tmp24
								tmp25 := checkDerefVar(var_ys_DOT_std_get_PLUS_)
								tmp26 := lang.Apply(tmp25, []any{v22, sym_out})
								tmp19 = tmp26
							} // end let
							tmp18 = tmp19
						} else {
				...
				tmp20 := lang.Apply(tmp5, []any{tmp6})
				tmp2 = tmp20
			} // end let
			return tmp2
		})
		tmp1 = tmp1.WithMeta(lang.NewMap(kw_rettag, nil)).(lang.FnFunc)
		var_gist_DOT_core_api_DASH_token = ns.InternWithValue(tmp0, tmp1, true)
		if tmp0.Meta() != nil {
			var_gist_DOT_core_api_DASH_token.SetMeta(tmp0.Meta().(lang.IPersistentMap))
		}
	}
	// main
	{
		...
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			...
			default:
				...
				tmp5 := checkDerefVar(var_clojure_DOT_core_first)
				tmp6 := lang.Apply(tmp5, []any{v2})
				tmp7 := lang.Apply(tmp4, []any{tmp6, "--version"})
				if lang.IsTruthy(tmp7) {
					tmp8 := checkDerefVar(var_ys_DOT_std_say)
					tmp9 := checkDerefVar(var_clojure_DOT_core_str)
					tmp10 := checkDerefVar(var_gist_DOT_core_VERSION)
					tmp11 := lang.Apply(tmp9, []any{"gist version ", tmp10, "\n"})
					tmp12 := lang.Apply(tmp8, []any{tmp11})
					_ = tmp12
					tmp13 := checkDerefVar(var_ys_DOT_std_exit)
					tmp14 := lang.Apply(tmp13, []any{int64(0)})
					tmp3 = tmp14
				} else {
				}
				_ = tmp3
				var tmp15 any
				{ // let
					// let binding "api-token"
					tmp16 := checkDerefVar(var_gist_DOT_core_api_DASH_token)
					tmp17 := lang.Apply(tmp16, nil)
					var v18 any = tmp17
					_ = v18
					// let binding "file-map"
					tmp19 := checkDerefVar(var_clojure_DOT_core_reduce)
					...
					tmp20 = lang.NewFnFunc(func(args ...any) any {
						...
						{ // let
							// let binding "m"
							tmp24 := checkDerefVar(var_ys_DOT_std__EQ__DASH__DASH_)
							tmp25 := checkDerefVar(var_gist_DOT_core_re_DASH_stdin)
							tmp26 := lang.Apply(tmp24, []any{v22, tmp25})
							var v27 any = tmp26
							_ = v27
							// let binding "name"
							var tmp28 any
							if lang.IsTruthy(v27) {
								...
								tmp30 := checkDerefVar(var_ys_DOT_std_get_PLUS_)
								tmp31 := lang.Apply(tmp30, []any{v27, int64(1)})
								tmp32 := lang.Apply(tmp29, []any{"stdin", tmp31})
								tmp28 = tmp32
							} else {
								tmp33 := checkDerefVar(var_ys_DOT_std_fs_DASH_filename)
							...
							_ = v35
							// let binding "content"
							tmp36 := checkDerefVar(var_ys_DOT_std_read)
							var tmp37 any
							if lang.IsTruthy(v27) {
								tmp37 = "/dev/stdin"
							} else {
							...
							var v39 any = tmp38
							_ = v39
							tmp40 := checkDerefVar(var_clojure_DOT_core_merge)
							tmp41 := checkDerefVar(var_ys_DOT_std__PCT_)
							tmp42 := checkDerefVar(var_ys_DOT_std__PCT_)
							tmp43 := lang.Apply(tmp42, []any{kw_content, v39})
							tmp44 := lang.Apply(tmp41, []any{v35, tmp43})
							tmp45 := lang.Apply(tmp40, []any{v21, tmp44})
							tmp23 = tmp45
						} // end let
						return tmp23
					})
					...
					tmp23 := checkDerefVar(var_ys_DOT_std__PCT_)
					...
					tmp26 := lang.Apply(tmp19, []any{tmp22, tmp24, tmp25})
					var v27 any = tmp26
					_ = v27
					// let binding "request"
					tmp28 := checkDerefVar(var_ys_DOT_std__PCT_)
					tmp29 := checkDerefVar(var_ys_DOT_std__PCT_)
					tmp30 := checkDerefVar(var_clojure_DOT_core_str)
					tmp31 := lang.Apply(tmp30, []any{"token ", v18})
					tmp32 := lang.Apply(tmp29, []any{kw_Authorization, tmp31})
					tmp33 := checkDerefVar(var_ys_DOT_json_dump)
					tmp34 := checkDerefVar(var_ys_DOT_std__PCT_)
					tmp35 := lang.Apply(tmp34, []any{"files", v27})
					tmp36 := lang.Apply(tmp33, []any{tmp35})
					tmp37 := lang.Apply(tmp28, []any{kw_headers, tmp32, kw_body, tmp36})
					var v38 any = tmp37
					_ = v38
					// let binding "response"
					tmp39 := checkDerefVar(var_ys_DOT_http_post)
					tmp40 := checkDerefVar(var_gist_DOT_core_api_DASH_url)
					tmp41 := lang.Apply(tmp39, []any{tmp40, v38})
					var v42 any = tmp41
					_ = v42
					var tmp43 any
					tmp44 := checkDerefVar(var_clojure_DOT_core__LT__EQ_)
					tmp45 := checkDerefVar(var_ys_DOT_std_get_PLUS_)
					tmp46 := lang.Apply(tmp45, []any{v42, sym_status})
					tmp47 := lang.Apply(tmp44, []any{int64(200), tmp46, int64(201)})
					if lang.IsTruthy(tmp47) {
					} else {
						tmp48 := checkDerefVar(var_ys_DOT_std_die)
						tmp49 := checkDerefVar(var_clojure_DOT_core_str)
						tmp50 := checkDerefVar(var_ys_DOT_std_get_PLUS_)
						tmp51 := lang.Apply(tmp50, []any{v42, sym_body})
						tmp52 := lang.Apply(tmp49, []any{"Gist request failed:\n\n", tmp51})
						tmp53 := lang.Apply(tmp48, []any{tmp52})
						tmp43 = tmp53
					}
					_ = tmp43
					tmp54 := checkDerefVar(var_ys_DOT_std_say)
					tmp55 := checkDerefVar(var_ys_DOT_std_get_PLUS_)
					tmp56 := checkDerefVar(var_ys_DOT_json_load)
					tmp57 := checkDerefVar(var_ys_DOT_std_get_PLUS_)
					tmp58 := lang.Apply(tmp57, []any{v42, sym_body})
					tmp59 := lang.Apply(tmp56, []any{tmp58})
					tmp60 := lang.Apply(tmp55, []any{tmp59, sym_html_url})
		...
		tmp1 = tmp1.WithMeta(lang.NewMap(kw_rettag, nil)).(lang.FnFunc)
		var_gist_DOT_core_main = ns.InternWithValue(tmp0, tmp1, true)
		if tmp0.Meta() != nil {
			var_gist_DOT_core_main.SetMeta(tmp0.Meta().(lang.IPersistentMap))
		}
	}
}
